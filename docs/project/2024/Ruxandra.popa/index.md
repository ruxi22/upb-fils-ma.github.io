...
| [static-cell](https://github.com/embassy-rs/static-cell) | Provides safe, static storage for data that outlives the main function | Used for managing static data |
